...
Companion localFiles handoff and handling outside Companion.
...
For an attached launch context, resolve exact versions using the launch tools
instead of attempting unrestricted Document discovery.
